<div class="wrap">
    <?php
    $wfm_posts = Wfmpanel_Admin::get_posts(5);
    $page = $_GET['paged'] ?? 1;
    ?>


    <h1><?php _e("Slide settings", 'wfmpanel') ?></h1>

    <p><?php echo __('Number of articles: ', 'wfmpanel') . $wfm_posts->found_posts ?></p>
